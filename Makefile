...
.PHONY: up-streaming create-topics produce-demo-events produce-random-events produce-defect-spike run-worker test-worker run-ingestion-demo reindex-search test-e2e
